...
{
    public static CreateCoverArgs ToCommandArgs(this CreateCoverRequestDto source)
    {
    ...
    public static CreateClaimArgs ToCommandArgs(this CreateClaimRequestDto source)
    {
