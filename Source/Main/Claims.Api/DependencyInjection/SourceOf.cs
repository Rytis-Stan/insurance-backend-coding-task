...
///
/// For each type of injection that should be injected, a class derived from this one should be
/// created with the appropriate name and should be used instead of the original dependency both
/// at the site of where it is registered and also where it gets injected. Getting to the real
/// dependency can be done by simply using the "Obj" property.
/// </summary>
/// <remarks>
