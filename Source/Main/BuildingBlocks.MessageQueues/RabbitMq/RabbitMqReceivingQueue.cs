...
/// Once that method is called, a new type of queue object gets returned. The queue will
/// keep receiving new messages until the new queue objects gets disposed of.
/// </summary>
